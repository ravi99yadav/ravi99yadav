...
(function(global){
  ...
  function seed(){
    ...
    // Hindrance Library — admin-managed catalog of standard delay events, editable/extendable from the Admin Panel.
    const libSeed = [
      { category:"Drawing", title:"Delayed Issue of IFC/GFC Drawings", description:"Approved-for-construction drawings not issued or issued with delay, preventing commencement of dependent activities.", rootCause:"Design consultant approval cycle delay, incomplete design coordination.", impact:"Direct delay to activities dependent on the drawing; potential critical path impact if on the critical path.", recoveryMethod:"Resequence non-dependent activities, expedite review once drawings issued, deploy additional resources on release.", evidenceRequired:"Drawing transmittal log, RFI correspondence, approval emails.", responsibleParty:"Client / Consultant", criticalPathImpact:true, defaultDelayRangeDays:"5-15", riskLevel:"High", mitigation:"Maintain a drawing tracker and raise RFIs proactively ahead of need-by dates." },
      { category:"Material", title:"Key Material Delivery Delay", description:"Critical construction material (cement, steel, aggregates, finishing items) not delivered on schedule.", rootCause:"Supplier production/logistics delay, transport disruption, procurement approval delay.", impact:"Stoppage or slowdown of dependent work fronts.", recoveryMethod:"Alternate vendor sourcing, partial deliveries, resequencing to unaffected work fronts.", evidenceRequired:"Purchase order, supplier delay letter, delivery challans, site material register.", responsibleParty:"Contractor / Supplier", criticalPathImpact:true, defaultDelayRangeDays:"3-10", riskLevel:"Medium", mitigation:"Maintain buffer stock for critical items and pre-qualify alternate vendors." },
      { category:"Weather", title:"Adverse Weather / Rain Stoppage", description:"Site work stopped or significantly slowed due to heavy rain, storm, or extreme weather beyond normal seasonal allowance.", rootCause:"Unseasonal or extreme weather event.", impact:"Loss of working days for weather-exposed activities (earthwork, concreting, external finishes).", recoveryMethod:"Compress schedule on weather-independent activities, deploy dewatering/covering measures.", evidenceRequired:"Site weather log, rain gauge records, DPR remarks, photographs.", responsibleParty:"Neutral (Force Majeure)", criticalPathImpact:false, defaultDelayRangeDays:"1-7", riskLevel:"Low", mitigation:"Plan weather-sensitive activities outside monsoon window where possible." },
      { category:"Approval", title:"Statutory Approval / NOC Pending", description:"Work cannot proceed pending a statutory permit, No Objection Certificate, or regulatory clearance.", rootCause:"Authority processing delay, incomplete application, policy change.", impact:"Full stoppage of the activity requiring the approval.", recoveryMethod:"Escalate through client/consultant liaison, parallel-track unaffected scopes.", evidenceRequired:"Application copy, authority correspondence, approval certificate once received.", responsibleParty:"Client", criticalPathImpact:true, defaultDelayRangeDays:"7-30", riskLevel:"High", mitigation:"Submit statutory applications well ahead of the need-by date with complete documentation." },
      { category:"Client", title:"Client Decision / Instruction Delay", description:"Work paused awaiting a client decision, site instruction, or handover of area/interface.", rootCause:"Client-side approval process, stakeholder alignment delay, funding decision.", impact:"Delay to the specific scope awaiting instruction; may cascade to dependent activities.", recoveryMethod:"Formal reminder/escalation letters, resequencing where possible.", evidenceRequired:"Site instruction request, correspondence trail, meeting minutes.", responsibleParty:"Client", criticalPathImpact:true, defaultDelayRangeDays:"3-14", riskLevel:"Medium", mitigation:"Track pending decisions in a single register and follow up formally in writing." },
      { category:"Shutdown", title:"Planned/Unplanned Utility Shutdown", description:"Work in an operating facility halted for a planned or emergency shutdown of plant, power, or utility.", rootCause:"Plant maintenance schedule, safety requirement, emergency condition.", impact:"Full stoppage of work requiring the shutdown window.", recoveryMethod:"Pre-plan shutdown-window activities to maximize productivity, extend shift hours post-shutdown.", evidenceRequired:"Shutdown notice/schedule, permit-to-work records.", responsibleParty:"Client / Plant Operations", criticalPathImpact:true, defaultDelayRangeDays:"1-5", riskLevel:"Medium", mitigation:"Confirm shutdown windows early and plan a detailed shutdown work package in advance." },
      { category:"Civil", title:"Sub-surface / Ground Condition Variance", description:"Actual ground/sub-surface conditions differ materially from those indicated in the tender/geotechnical report.", rootCause:"Unforeseen soil strata, water table, buried utilities/obstructions.", impact:"Redesign of foundation/excavation method, additional time for revised approach.", recoveryMethod:"Fast-track redesign approval, mobilize specialist equipment.", evidenceRequired:"Geotechnical report comparison, site photographs, surveyor records.", responsibleParty:"Client / Neutral", criticalPathImpact:true, defaultDelayRangeDays:"5-20", riskLevel:"High", mitigation:"Conduct thorough geotechnical investigation before finalizing foundation design." },
      { category:"Electrical", title:"Power Supply Interruption", description:"Site or permanent power supply unavailable or interrupted, halting equipment/tools requiring electricity.", rootCause:"Grid outage, delayed permanent power connection, generator failure.", impact:"Stoppage of electrically powered activities and equipment.", recoveryMethod:"Standby DG set deployment, temporary connection arrangement.", evidenceRequired:"Utility outage notice, DG log, DPR remarks.", responsibleParty:"Client / Utility Provider", criticalPathImpact:false, defaultDelayRangeDays:"1-3", riskLevel:"Low", mitigation:"Arrange adequate standby power capacity for critical activities." },
      { category:"Mechanical", title:"Equipment Breakdown / Non-availability", description:"Key plant or equipment (crane, batching plant, pump) breaks down or is unavailable when required.", rootCause:"Mechanical failure, inadequate maintenance, equipment sharing conflicts.", impact:"Delay to activities dependent on that equipment.", recoveryMethod:"Arrange replacement/rental equipment, expedite repair.", evidenceRequired:"Equipment log, breakdown/service report, rental invoice.", responsibleParty:"Contractor", criticalPathImpact:false, defaultDelayRangeDays:"1-5", riskLevel:"Medium", mitigation:"Maintain a preventive maintenance schedule and identify backup equipment sources." },
      { category:"Instrumentation", title:"Instrumentation/Automation Interface Delay", description:"Instrumentation or control system integration delayed pending vendor documents or interface finalization.", rootCause:"Vendor document delay, interface design not finalized, testing dependency.", impact:"Delay to commissioning-stage activities.", recoveryMethod:"Parallel testing of unaffected loops, vendor expediting.", evidenceRequired:"Vendor document register, interface control document, correspondence.", responsibleParty:"Vendor / Client", criticalPathImpact:true, defaultDelayRangeDays:"5-15", riskLevel:"Medium", mitigation:"Finalize interface control documents early in the engineering phase." },
      { category:"HVAC", title:"HVAC Equipment/Ducting Material Delay", description:"HVAC equipment, ductwork, or insulation material delayed, affecting installation sequence.", rootCause:"Long-lead equipment manufacturing time, shipping delay.", impact:"Delay to HVAC installation and dependent finishing/commissioning activities.", recoveryMethod:"Expedite shipping, resequence to other MEP scopes meanwhile.", evidenceRequired:"Purchase order, shipping tracking, delivery record.", responsibleParty:"Vendor", criticalPathImpact:false, defaultDelayRangeDays:"5-20", riskLevel:"Medium", mitigation:"Place long-lead HVAC equipment orders at contract award stage." },
      { category:"Pipeline", title:"Pipeline Right-of-Way / Route Obstruction", description:"Pipeline laying blocked by right-of-way dispute, utility crossing, or unforeseen obstruction along the route.", rootCause:"Land acquisition delay, third-party utility crossing approval, unmapped obstruction.", impact:"Full stoppage of pipeline laying at the affected chainage.", recoveryMethod:"Reroute planning, parallel work on unaffected chainages, expedite approvals.", evidenceRequired:"Route survey, right-of-way correspondence, obstruction photographs.", responsibleParty:"Client / Third Party", criticalPathImpact:true, defaultDelayRangeDays:"7-25", riskLevel:"High", mitigation:"Complete right-of-way clearance and utility mapping before mobilization." },
      { category:"Fire Fighting", title:"Fire Fighting System Approval Delay", description:"Fire fighting system design/installation awaiting Fire NOC or third-party inspection approval.", rootCause:"Regulatory review cycle, design revision requirement.", impact:"Delay to occupancy/handover milestone dependent on Fire NOC.", recoveryMethod:"Pre-submission coordination with authority, mock inspection before formal submission.", evidenceRequired:"NOC application, inspection report, authority correspondence.", responsibleParty:"Client / Authority", criticalPathImpact:true, defaultDelayRangeDays:"7-20", riskLevel:"Medium", mitigation:"Engage the fire authority early with a pre-approved design basis." },
      { category:"Safety", title:"Safety Stop-Work Order", description:"Work stopped by a safety officer/authority due to an unsafe condition or incident investigation.", rootCause:"Safety non-compliance identified, incident requiring investigation.", impact:"Full stoppage of the affected work front until corrective action is verified.", recoveryMethod:"Immediate corrective action, safety retraining, phased restart with enhanced supervision.", evidenceRequired:"Stop-work notice, incident report, corrective action closure record.", responsibleParty:"Contractor", criticalPathImpact:true, defaultDelayRangeDays:"1-5", riskLevel:"High", mitigation:"Maintain rigorous HSE compliance and toolbox talks to prevent stop-work triggers." },
      { category:"Quality", title:"Non-conformance Rework", description:"Work rejected at inspection and requires rework/rectification before proceeding.", rootCause:"Workmanship deviation, material non-conformance, inadequate QA/QC checks.", impact:"Time lost in rework plus re-inspection cycle.", recoveryMethod:"Root-cause corrective action, enhanced QC checkpoints, parallel work on unaffected areas.", evidenceRequired:"Non-conformance report, inspection request, rectification record.", responsibleParty:"Contractor", criticalPathImpact:false, defaultDelayRangeDays:"2-7", riskLevel:"Medium", mitigation:"Strengthen QC hold-points before proceeding to the next stage of work." },
      { category:"Others", title:"Other / Unclassified Hindrance", description:"A hindrance not covered by the standard categories above — describe fully in the project record.", rootCause:"Varies — specify in the hindrance description.", impact:"Varies — assess case by case.", recoveryMethod:"To be assessed based on the specific circumstance.", evidenceRequired:"Relevant correspondence, photographs, or records supporting the claim.", responsibleParty:"To be determined", criticalPathImpact:false, defaultDelayRangeDays:"—", riskLevel:"Medium", mitigation:"Document thoroughly with dates, cause and effect for future reference." }
    ];
    libSeed.forEach(l=> DB.hindranceLibrary.create(l));
